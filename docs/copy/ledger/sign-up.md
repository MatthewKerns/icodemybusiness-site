...
Extracted from the live page 2026-09-08, document order (14 lines incl. shared header/footer, reviewed once in `shared.md`). Verdicts are the agent's; the `Matthew` column is his ruling, verbatim.
